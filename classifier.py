...
json_data = None
with open('./data/train_cartridge.json') as data_file:
...
target_names = ['REPRO', 'NOT_A_GAME', 'BUNDLE', 'GRADED', 'SEALED', 'CIB', 'BOX_AND_GAME',
...
print(model.predict(
    ['GAME BOY COLOR Midwest LED integrado ~ especial MAN PIKACHU Edition * solo consola *']))
